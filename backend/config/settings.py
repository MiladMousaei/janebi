...
INSTALLED_APPS = [
    ...
    "django_filters", "drf_spectacular", "apps.core", "apps.users",
    "apps.catalog", "apps.commerce",
]
MIDDLEWARE = [
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@janebi.local")
REST_FRAMEWORK = {
...
SPECTACULAR_SETTINGS = {"TITLE": "Janebi Store API", "DESCRIPTION": "API فروشگاه جانبی", "VERSION": "1.0.0", "SERVE_INCLUDE_SCHEMA": False}
